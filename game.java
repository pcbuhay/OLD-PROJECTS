...
public class stackme  extends JFrame implements KeyListener {
        int iteration = 1;
 ...
 int counter  = 0;
        ...
        public void go(){
                ...
                length[1] = tmp;
                if (layer == -1){
                        JOptionPane.showMessageDialog(temporaryLostComponent, "IKAWANG HIGHSCORE SALAMA SA PAGLALARO!");
                }
                if (length[1] <= 0){   
                        JOptionPane.showMessageDialog(temporaryLostComponent, "GAME OVER Thank you for playing your score is "+(55-layer)+"!    Email us DreamStarUniverse@yahoo.com ");
            System.exit(0);
                }
                last = deltax[1];
                start = false;
        ...
        public void draw(){
                ...
                for (int x = 0;x<length[1];x++){
                        b[x+deltax[1]][layer].setBackground(Color.BLACK);
                        }
        }
        @Override
